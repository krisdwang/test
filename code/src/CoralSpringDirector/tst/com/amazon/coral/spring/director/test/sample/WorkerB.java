...
public class WorkerB implements ApplicationListener<NamedEvent> {
    ...
    public void onApplicationEvent(NamedEvent event) {
        ...
        for (int i = 0; i < iterations; i++) {
            ...
            log.debug("    worker B: working to" + event.toString().replace('{', ' ').replace('}', ' '));
        }
