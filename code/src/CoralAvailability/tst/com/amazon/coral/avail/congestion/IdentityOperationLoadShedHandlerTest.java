...
public class IdentityOperationLoadShedHandlerTest {
  ...
  public void migrationBuilder() throws Throwable {
    ...
    LoadShedHandler h = LoadShedHandler.buildForIdentityOperation(
    ...
    com.amazon.coral.avail.Helper.verifyKeys(throttler, "droppable-aws-account:throttled,Operation:MyService/OperationA", "droppable");
  }
}
