...
public class IdentityOperationThrottlingHandlerTest {
  ...
  public void migrationBuilder() throws com.amazon.coral.availability.ThrottlingException {
    ...
    ThrottlingHandler h = ThrottlingHandler.buildForIdentityOperation(
    ...
    com.amazon.coral.avail.Helper.verifyKeys(throttler, "ID_OP:aws-account:throttled,Operation:MyService/OperationA", "");
  }
  @Test
  public void migrationBuilderSansPrefix() throws com.amazon.coral.availability.ThrottlingException {
    ...
    com.amazon.coral.avail.Helper.verifyKeys(throttler, "aws-account:throttled,Operation:MyService/OperationA", "");
  }
}
