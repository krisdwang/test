...
public class OperationThrottlingHandlerTest {
  ...
  public void migrationBuilder() throws com.amazon.coral.availability.ThrottlingException {
    ...
    ThrottlingHandler h = ThrottlingHandler.buildForOperation(
        true,
        throttler,
        Collections.<CharSequence>emptyList());
    h.before(ctx);

    com.amazon.coral.avail.Helper.verifyKeys(throttler, "OP:Operation:MyService/OperationA", "");
  }
  @Test
  public void migrationBuilderSansPrefix() throws com.amazon.coral.availability.ThrottlingException {
    ...
    com.amazon.coral.avail.Helper.verifyKeys(throttler, "Operation:MyService/OperationA", "");
  }
}
