...
//                    throw new IllegalStateException("Decoding Failed.");
    ...
    private static ArrayList<Map> decodeAll(byte[][] encodedMaps) throws DecodingException {
    ...
    private static byte[][] encodeAll(ArrayList<Map> maps) throws EncodingException {
